...
using System;
using System.IO;
using ArchivingServices.Structure.SevenZip.Compression.LZ;
using ArchivingServices.Structure.SevenZip.Compression.RangeCoder;

namespace ArchivingServices.Structure.SevenZip.Compression.Lzma
{
    /// <summary>
